...
var store = {
    ...
    insert_stamp : function (_stampInfo, _callback){
        ...
        const execute = (connection, next) => { 
            ...
            connection.query("INSERT INTO stamp (storeId, stampTerm, stampMaximum) values (?, ?, ? ) "
                            , [ _stampInfo.storeId, _stampInfo.stampTerm, _stampInfo.stampMaximum ]
                            , (err, results) => {
                                ...
                                connection.query(" INSERT INTO coupon_config (storeId, stampId, couponPublishTerm, couponItemName, itemImgId) VALUES ?"
                                                    , [ qq ]
                                                    , (err, results) => {
